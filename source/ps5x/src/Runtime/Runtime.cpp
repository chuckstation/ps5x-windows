...
void ReportTimings()
{
    ...
    for (const auto& t : timings) {
        ...
        PS5X_INFO("[Runtime]  %-14s  %s  init=%.2f ms  shutdown=%.2f ms%s",
                  SubsystemName(t.id),
...
void RegisterDefaults()
{
    ...
    Register({
        Id::Logger, "Logger",
        []{ PS5x::Logger::Init("ps5x.log", true, PS5x::Logger::Level::Info); return true; },
    ...
    Register({
        ...
        []{ PS5x::Filesystem::Init(); return true; },
