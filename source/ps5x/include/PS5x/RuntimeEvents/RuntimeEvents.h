...
using EventPayload =
	std::variant<std::monostate, ProcessExitedPayload, ProcessFaultedPayload, ThreadPayload, ModulePayload,
				 SymbolPayload, PageFaultPayload, SyscallPayload, FramePayload, ProfilePayload, CustomPayload>;
