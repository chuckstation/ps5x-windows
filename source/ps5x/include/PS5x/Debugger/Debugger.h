...
// ── Phase 8: Module browser ───────────────────────────────────────────────
std::vector<ModuleEntry> GetModuleList();

// ── Phase 8: Symbol browser ───────────────────────────────────────────────
...
uint32_t AddWatchpoint(uint64_t address, size_t size, bool onRead = false, bool onWrite = true, std::string label = "");
...
uint32_t AddConditionalBreakpoint(uint64_t address, BreakConditionFn condition, std::string label = "");
