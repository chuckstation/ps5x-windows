...
TEST_CASE("Phase6::KR::ObjectNamespace::RegisterAndLookup",
          "[kernel_runtime][phase6]") {
...
TEST_CASE("Phase6::KR::ObjectNamespace::LookupMissing",
          "[kernel_runtime][phase6]") {
  CHECK(LookupName("no_such_object") == INVALID_HANDLE);
}

TEST_CASE("Phase6::KR::ObjectNamespace::UnregisterName",
          "[kernel_runtime][phase6]") {
...
TEST_CASE("Phase6::KR::ObjectNamespace::SeparateNamespaces",
          "[kernel_runtime][phase6]") {
...
TEST_CASE("Phase6::KR::ObjectNamespace::OverwriteHandle",
          "[kernel_runtime][phase6]") {
...
TEST_CASE("Phase6::KR::ObjectNamespace::UnregisterMissing",
          "[kernel_runtime][phase6]") {
...
TEST_CASE("Phase6::KR::WaitQueue::WakeOne_noWaiters",
          "[kernel_runtime][phase6]") {
...
TEST_CASE("Phase6::KR::WaitQueue::WakeOneUnblocksWaiter",
          "[kernel_runtime][phase6]") {
...
TEST_CASE("Phase6::KR::WaitQueue::WakeAllUnblocksMultiple",
          "[kernel_runtime][phase6]") {
  WqHandle wq = CreateWaitQueue("wake_all_test");
  std::atomic<int> woke{0};

  auto worker = [&] {
    WaitOnQueue(wq, 5'000'000);
    woke.fetch_add(1);
  };
...
TEST_CASE("Phase6::KR::WaitQueue::TimeoutReturnsfalse",
          "[kernel_runtime][phase6]") {
...
TEST_CASE("Phase6::KR::ResourceLimits::DefaultLimits",
          "[kernel_runtime][phase6]") {
