...
TEST_CASE("Phase8::Concurrency::Logger::ConcurrentWrites", "[concurrency][phase8]")
{
...
TEST_CASE("Phase8::Concurrency::RuntimeEvents::ConcurrentPublish", "[concurrency][phase8]")
{
    RuntimeEvents::Init();
    ...
    std::vector<std::thread> threads;
    for (int i = 0; i < THREADS; ++i) threads.emplace_back(publisher);
    for (auto& t : threads) t.join();
...
TEST_CASE("Phase8::Concurrency::RuntimeEvents::ConcurrentSubscribePublish", "[concurrency][phase8]")
{
    RuntimeEvents::Init();
...
TEST_CASE("Phase8::Concurrency::Memory::ConcurrentAllocFree", "[concurrency][phase8]")
{
    Memory::Init();
    std::atomic<bool> crashed{false};
...
TEST_CASE("Phase8::Concurrency::Cpu::StatsQueryWhileRunning", "[concurrency][phase8]")
{
    Cpu::Init();
...
TEST_CASE("Phase8::Concurrency::Cpu::ConcurrentBreakpointAddRemove", "[concurrency][phase8]")
{
    Cpu::Init();
    std::atomic<bool> crashed{false};
...
TEST_CASE("Phase8::Concurrency::PerfTools::ConcurrentFrameTime", "[concurrency][phase8]")
{
    PerfTools::Init();
    std::atomic<bool> crashed{false};
...
TEST_CASE("Phase8::Concurrency::PerfTools::ConcurrentScopeTimers", "[concurrency][phase8]")
{
    PerfTools::Init();
    std::atomic<bool> crashed{false};
...
TEST_CASE("Phase8::Concurrency::Syscall::ConcurrentDispatch", "[concurrency][phase8]")
{
    Syscalls::Init();
